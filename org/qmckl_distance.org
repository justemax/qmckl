...
qmckl_exit_code qmckl_distance_c (
  ...
  printf("Ok je rentre dans qmckl distance version c \n");

  if (context == QMCKL_NULL_CONTEXT){
    printf("Return error from distance c\n");
...
// check for LDC
  ...
  printf("Value of C 1 inside C loop : %lf", C[1]);

  printf("ok fini le bordel\n");
