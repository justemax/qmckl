...
{
  /* Should always be true by contruction */
  printf("Coucou le debut d'alloc du vecteur\n");
  assert (size > (int64_t) 0);
                              ...
                              int device_id)
{
  ...
  printf("before le memcpy\n");
  #pragma acc data deviceptr(vector.data_device)
  {
    printf("%p\n", vector.data_device);
    printf("%d\n", target[0]);
                        ...
                        qmckl_matrix At )
{
  ...
  #pragma acc data deviceptr(A_data, At_data)
  {
    ...
    printf("fini ce truc de mort laaaa\n");
  }
