...
qmckl_exit_code qmckl_provide_een_rescaled_e_deriv_e(qmckl_context context)
{
  ...
  /* Check if ee distance is provided */
printf("avant provide een rescaled e\n");
    ...
    for(int j = 0; j < elec_num; j++){
      for(int i = 0; i < elec_num; i++){
        ...
        for(int ii=0; ii < 3; ii++){
          ...
          // OK LE VALEURS SONT OK ICI
        }
        elec_dist_deriv_e[j*elec_num*4 + i*4 + 3] = 2 * rij_inv;
        //printf("%lf\n",elec_dist_deriv_e[j*elec_num*4 + i*4 + 3]);
        // Valeur ok ici aussi
      }
      ...
      for(int j=0; j < elec_num; j++){
        for(int i=0; i < elec_num ; i++){
         ...
         //printf("%lf \n",  een_rescaled_e_deriv_e[nw * (cord_num+1) * elec_num * 4 *elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 3 * elec_num + i] );
          ...
          //OK mega calcul de ses moort la
          //printf("%lf\n",  een_rescaled_e_deriv_e[nw * (cord_num+1) * elec_num * 4 *elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 3 * elec_num + i]);
          ...
          printf("%lf\n",een_rescaled_e_deriv_e[nw * (cord_num+1) * elec_num * 4 *elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 3 * elec_num + i]);
          //printf("%lf\n", een_rescaled_e[nw * ((cord_num+1)) * elec_num * elec_num + l * elec_num * elec_num + j * elec_num + i]);
