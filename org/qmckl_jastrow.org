    ...
    do l = 1, cord_num
      ...
      do j = 1, elec_num
        do i = 1, elec_num
          ...
          print *, een_rescaled_e_deriv_e(i, 1, j, l, nw);
...
qmckl_exit_code qmckl_compute_factor_een_rescaled_e_deriv_e_c (
    ...
    for(int l=1; l < cord_num+1; l++){
      ...
      for(int j=0; j < elec_num; j++){
        for(int i=0; i < elec_num ; i++){
          ...
          een_rescaled_e_deriv_e[nw * cord_num+1 * elec_num * 4 *elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 0 * elec_num + i] = kappa_l * elec_dist_deriv_e[i * elec_num * 4 + j * 4 + 0];

          printf("%lf",elec_dist_deriv_e[i * elec_num * 4 + j * 4 + 0]);
          printf("\n %lf \n",  een_rescaled_e_deriv_e[nw * cord_num+1 * elec_num * 4 *elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 0 * elec_num + i] );

          een_rescaled_e_deriv_e[nw * cord_num+1 * elec_num * 4 *elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 1 * elec_num + i] = \
            kappa_l * elec_dist_deriv_e[i * elec_num * 4 + j * 4 + 1];

          een_rescaled_e_deriv_e[nw * cord_num+1 * elec_num * 4 *elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 2 * elec_num + i] = \
            kappa_l * elec_dist_deriv_e[i * elec_num * 4 + j * 4 + 2];

          een_rescaled_e_deriv_e[nw * cord_num+1 * elec_num * 4 *elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 3 * elec_num + i] = \
            kappa_l * elec_dist_deriv_e[i * elec_num * 4 + j * 4 + 3];
  ...
  printf("%lf \n", een_rescaled_e_deriv_e[0 * cord_num + 1 * elec_num * 4 * elec_num + 1 * elec_num * 4 * elec_num + 0 + 0 + 2]);
