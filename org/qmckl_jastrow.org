...
qmckl_exit_code qmckl_provide_een_rescaled_e_deriv_e(qmckl_context context)
{
  ...
  if (ctx->date > ctx->jastrow.een_rescaled_e_deriv_e_date) {
    ...
    printf("Go qmckl compute factor \n\n");
...
qmckl_exit_code qmckl_compute_factor_een_rescaled_e_deriv_e_c (
  ...
  printf("Inside compute factor\n");

  printf("pointer of cordNew = %p\n", coord_new);
  printf("size of cordNew = %lf\n", coord_new[0]);
  ...
  for(int nw = 0; nw < walk_num; nw++){
    for(int j = 0; j < elec_num; j++){
      for(int i = 0; i < elec_num; i++){
        ...
        for(int ii=0; ii < 3; ii++){
          //printf("1 %lf\n",elec_dist_deriv_e[j*elec_num * 4 + i * 4 + ii]);
          //printf("%lf\n",coord_new[nw * 3 *elec_num + ii * elec_num + i]);
    ...
    for(int l=0; l < cord_num; l++){
      ...
      for(int j=0; j < elec_num; j++){
        for(int i=0; i < elec_num ; i++){
          een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 0 * elec_num + i] = kappa_l * elec_dist_deriv_e[j * elec_num * 4];
          een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 1 * elec_num + i] = kappa_l * elec_dist_deriv_e[j * elec_num * 4];
          een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 2 * elec_num + i] = kappa_l * elec_dist_deriv_e[j * elec_num * 4];
          een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 3 * elec_num + i] = kappa_l * elec_dist_deriv_e[j * elec_num * 4];

          een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 0 * elec_num + i] = een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 0 * elec_num + i] * een_rescaled_e[nw * cord_num * elec_num * elec_num + l * elec_num * elec_num + j * elec_num + i];
          een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 1 * elec_num + i] = een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 1 * elec_num + i] * een_rescaled_e[nw * cord_num * elec_num * elec_num + l * elec_num * elec_num + j * elec_num + i];
          een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 2 * elec_num + i] = een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 2 * elec_num + i] * een_rescaled_e[nw * cord_num * elec_num * elec_num + l * elec_num * elec_num + j * elec_num + i];
          een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 3 * elec_num + i] = een_rescaled_e_deriv_e[nw * cord_num * elec_num * 4 * elec_num + l * elec_num * 4 * elec_num + j * 4 * elec_num + 3 * elec_num + i] * een_rescaled_e[nw * cord_num * elec_num * elec_num + l * elec_num * elec_num + j * elec_num + i];
